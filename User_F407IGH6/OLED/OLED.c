...
#define OLED_W_SCL(x)		HAL_GPIO_WritePin(GPIOF, GPIO_PIN_SCL, (GPIO_PinState)(x))
#define OLED_W_SDA(x)		HAL_GPIO_WritePin(GPIOF, GPIO_PIN_SDA, (GPIO_PinState)(x))
...
void OLED_ShowPicture(uint8_t location,uint8_t FLAG)
{
