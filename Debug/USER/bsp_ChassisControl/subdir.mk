...
C_SRCS += \
../USER/bsp_ChassisControl/Chassis_Control.c 

OBJS += \
./USER/bsp_ChassisControl/Chassis_Control.o 

C_DEPS += \
./USER/bsp_ChassisControl/Chassis_Control.d 


# Each subdirectory must supply rules for building sources it contributes
USER/bsp_ChassisControl/%.o USER/bsp_ChassisControl/%.su: ../USER/bsp_ChassisControl/%.c USER/bsp_ChassisControl/subdir.mk
...
clean: clean-USER-2f-bsp_ChassisControl

clean-USER-2f-bsp_ChassisControl:
	-$(RM) ./USER/bsp_ChassisControl/Chassis_Control.d ./USER/bsp_ChassisControl/Chassis_Control.o ./USER/bsp_ChassisControl/Chassis_Control.su

.PHONY: clean-USER-2f-bsp_ChassisControl
